...
const reactDomClientDefault = pickDefault(reactDomClientModule);
...
expose('ReactDOMClient', reactDomClientModule || null);
expose('reactDomClient', reactDomClientDefault || null);
expose('createRoot', (reactDomClientModule && reactDomClientModule.createRoot) ? reactDomClientModule.createRoot : (reactDomModule && reactDomModule.createRoot ? reactDomModule.createRoot : null));
